	...
	>
		<div>
			<h3 class="flex items-center m-0 font-medium text-lg">
				<svg viewBox="0 0 512 512" class="w-12 lg:w-8 mr-3">
					<path
			...
			<div class="font-normal text-sm mt-4 mb-4 text-white overflow-hidden">
				Grab yourself 10 free images from Adobe Stock in a 30-day free trial plan and find perfect
				image, that will help you with your new project.
			</div>
			<button class="py-2 px-4 bg-blue-700 text-white rounded-2xl"> Start free trial </button>
		</div>
		<img
			class="w-24 md:w-44 object-cover object-center"
			src="https://assets.codepen.io/3364143/glass.png"
			alt=""
		/>
	</div>
	<div class="mt-6 mb-3 text-gray-700 font-medium">Installed</div>
	<div class="p-4 font-normal rounded-2xl" style=" background-color: rgba(158, 158, 158, 0.3)">
		<div class="flex justify-end pb-2 mb-6 border-b border-gray-600">
			<div class="mr-auto flex">
				<svg viewBox="0 0 52 52" style="border: 1px solid #3291b8" class="w-7 h-7 rounded mr-4">
			...
			<div class="mx-auto flex">
				<span class="relative text-base">
					<span class="h-2 w-2 absolute rounded-full top-1 left--2 bg-green-400" />
					<span class="pl-4">Updated</span>
				</span>
			</div>
			<div class="ml-auto flex">
				<div>
					<button class="border-gray-500 rounded-full px-5 py-1 border text-gray-500">
						Open
					</button>
				</div>
			</div>
		...
		<div class="flex justify-end pb-2 mb-6 border-b border-gray-600">
			<div class="mr-auto flex">
				<svg viewBox="0 0 52 52" style="border: 1px solid #b65a0b" class="w-7 h-7 rounded mr-4">
					<g xmlns="http://www.w3.org/2000/svg">
						<path
							d="M40.824 52H11.176C5.003 52 0 46.997 0 40.824V11.176C0 5.003 5.003 0 11.176 0h29.649C46.997 0 52 5.003 52 11.176v29.649C52 46.997 46.997 52 40.824 52z"
							fill="#261400"
			...
			<div class="mx-auto flex">
				<span class="relative text-base">
					<span class="h-2 w-2 absolute rounded-full top-1 left--2 bg-indigo-400" />
					<span class="pl-4">Updated</span>
				</span>
			</div>
			<div class="ml-auto flex">
		...
		<div class="flex justify-end">
			<div class="mr-auto flex">
				<svg viewBox="0 0 52 52" style="border: 1px solid #C75DEB" class="w-7 h-7 rounded mr-4">
					<g xmlns="http://www.w3.org/2000/svg">
						<path
							d="M40.824 52H11.176C5.003 52 0 46.997 0 40.824V11.176C0 5.003 5.003 0 11.176 0h29.649C46.997 0 52 5.003 52 11.176v29.649C52 46.997 46.997 52 40.824 52z"
							fill="#3a3375"
								...
								<tr>
									<td class="px-5 py-5 border-b border-gray-200 text-sm">
										<div class="flex items-center">
											...
											<div class="ml-3">
												<p class="whitespace-no-wrap">Eric marc</p>
											</div>
										</div>
									</td>
									<td class="px-5 py-5 border-b border-gray-200 text-sm">
										<p class="whitespace-no-wrap">Developer</p>
									</td>
									<td class="px-5 py-5 border-b border-gray-200 text-sm">
										<p class="whitespace-no-wrap">02/10/2018</p>
									</td>
									<td class="px-5 py-5 border-b border-gray-200 text-sm">
										<span class="relative inline-block px-3 py-1 font-semibold leading-tight">
											<span
								...
								<tr>
									<td class="px-5 py-5 border-b border-gray-200 text-sm">
										<div class="flex items-center">
											...
											<div class="ml-3">
												<p class="whitespace-no-wrap">Julien Huger</p>
											</div>
										</div>
									</td>
									<td class="px-5 py-5 border-b border-gray-200 text-sm">
										<p class="whitespace-no-wrap">User</p>
									</td>
									<td class="px-5 py-5 border-b border-gray-200 text-sm">
										<p class="whitespace-no-wrap">23/09/2010</p>
									</td>
									<td class="px-5 py-5 border-b border-gray-200 text-sm">
										<span
											class="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight"
