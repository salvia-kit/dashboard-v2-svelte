<script>
	import { openSidenav } from '../provider/store';
</script>

<header class="h-16 items-center relative w-full z-10 md:h-20">
		...
		<div class="flex items-center pl-1 relative w-full sm:pr-2 sm:ml-0 lg:max-w-68 ">
			<div class="container flex h-auto h-full left-0 relative w-3/4">
				...
				<div class="group h-full hidden items-center relative w-full md:flex lg:w-64">
					...
					/>
					<div
						class="absolute border border-gray-300 h-auto hidden mr-2 px-2 py-1 right-0 rounded-2xl text-xs text-gray-400 md:block"
					>
						+
					</div>
				</div>
			...
			>
				...
				<a href="#" class="block inline-block py-2 px-3 relative rounded text-gray-700">
					<span>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							class="h-6 w-6"
					...
					<span
						class="absolute bg-blue-700 font-bold px-2 py-0.5 right-0 rounded-full text-white text-xs top-0"
					>
						3
					</span>
				</a>
